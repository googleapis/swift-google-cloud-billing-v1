...
public struct MoveBillingAccountRequest: Codable, Equatable, GoogleCloudWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `MoveBillingAccountRequest`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = MoveBillingAccountRequest().with { $0.name = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.billing.v1.MoveBillingAccountRequest"
  }
