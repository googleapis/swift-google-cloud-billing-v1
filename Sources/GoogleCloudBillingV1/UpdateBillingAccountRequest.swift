...
public struct UpdateBillingAccountRequest: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  /// server.
  public var account: BillingAccount? = nil
  ...
  /// Initialize a new instance of `UpdateBillingAccountRequest`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = UpdateBillingAccountRequest().with { $0.name = ... }
  /// ```
  ...
  public init(from decoder: Decoder) throws {
    ...
    self.account = try container.decodeIfPresent(BillingAccount.self, forKey: .account)
